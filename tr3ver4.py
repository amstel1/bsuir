...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        self.btn5.clicked.connect(lambda: plotCan.plot_determined(self.combo1, self.spin1, self.param1, self.param2, self.param3))
...
class PlotCanvas(FigureCanvas):
    ...
    def plot_determined(self, trend_type, n_, a_, b_, c_):
        sns.set_style('darkgrid')
        plt.style.use('ggplot')
